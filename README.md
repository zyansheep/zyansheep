...
I am working to create a [decentralized and privacy-respecting Internet](https://dither.link/).

I am working to create a [universal programming language](https://disp-lang.net/), where the type system is just a library, the parser is also just a library, and self-modifying, and where you can write a program specification and have a general optimizer generate the program.
