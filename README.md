...
I am working to create a [universal programming language](https://dither.link/docs/disp/disp.html), where the type system is just a library, the parser is also just a library, and self-modifying, and where you can write a program specification and have a general optimizer generate the program.
